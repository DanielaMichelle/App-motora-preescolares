...
import 'preschooler_form_model.dart';
export 'preschooler_form_model.dart';

class PreschoolerFormWidget extends StatefulWidget {
  const PreschoolerFormWidget({super.key});

  @override
  State<PreschoolerFormWidget> createState() => _PreschoolerFormWidgetState();
}

class _PreschoolerFormWidgetState extends State<PreschoolerFormWidget> {
  late PreschoolerFormModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PreschoolerFormModel());
    ...
    _model.waistCircumferenceTextController ??= TextEditingController();
    _model.waistCircumferenceFocusNode ??= FocusNode();
  }
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 24.0),
                                      child: Text(
                                        'Ingresa los datos del preescolar',
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller: _model
                                            .waistCircumferenceTextController,
                                        focusNode:
                                            _model.waistCircumferenceFocusNode,
                                        autofocus: true,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          labelText:
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      unawaited(
                                        () async {
                                          await PreschoolChildRecord.collection
                                              .doc()
                                              .set(
